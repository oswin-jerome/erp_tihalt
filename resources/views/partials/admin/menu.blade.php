                ...
                @if (Gate::check('show hrm dashboard') ||
                                                ...
                                                <ul class="dash-submenu">
                                                    ...
                                                    @can('loss & profit report')
                                                        <li
                                                            ...
                                                            <a class="dash-link"
                                                                href="{{ route('report.profit.loss.summary') }}">{{ __('Profit & Loss') }}</a>
                                                        </li>
                                                    @endcan
                                ...
                                <ul class="dash-submenu">
                                    <li
                                        ...
                                        @if (\Auth::user()->type == 'Employee')
                                            ...
                                            @endphp
                                            <a class="dash-link"
                                                href="{{ route('employee.show', \Illuminate\Support\Facades\Crypt::encrypt(\Auth::user()->id)) }}">{{ __('Employee') }}</a>
                                        @else
                                            ...
                                            <ul class="dash-submenu">
                                                ...
                                                @can('show career')
                                                    <li class="dash-item {{ request()->is('career*') ? 'active' : '' }}">
                                                        <a class="dash-link"
                                                            href="{{ route('career', [\Auth::user()->creatorId(), 'en']) }}">{{ __('Career') }}</a>
                                                    </li>
                                                @endcan
                                            </ul>
                                        </li>
                        ...
                        @if (Gate::check('manage customer') ||
                            ...
                            <li
                                ...
                                <a href="#!" class="dash-link"><span class="dash-micon"><i
                                        ...
                                        class="dash-mtext">{{ __('Accounting System ') }}</span><span
                                        class="dash-arrow">
                                        <i data-feather="chevron-right"></i></span>
                                </a>
                                <ul class="dash-submenu">
                    ...
                    @if (\Auth::user()->show_crm() == 1)
                        @if (Gate::check('manage lead') || Gate::check('manage deal') || Gate::check('manage form builder'))
                            <li
                                class="dash-item dash-hasmenu {{ Request::segment(1) == 'stages' || Request::segment(1) == 'labels' || Request::segment(1) == 'sources' || Request::segment(1) == 'lead_stages' || Request::segment(1) == 'pipelines' || Request::segment(1) == 'deals' || Request::segment(1) == 'leads' || Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' ? ' active dash-trigger' : '' }}">
                                <a href="#!" class="dash-link"><span class="dash-micon"><i
                    ...
                    @if (\Auth::user()->show_project() == 1)
                        @if (Gate::check('manage project'))
                            <li
                                class="dash-item dash-hasmenu {{ Request::segment(1) == 'project' ||
                                ...
                                <ul class="dash-submenu">
                                    ...
                                    @if (Gate::check('manage project task stage') || Gate::check('manage bug status'))
                                        <li
                                            ...
                                            <a class="dash-link"
                                                href="#">{{ __('Project System Setup') }}<span
                                                    class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                            <ul class="dash-submenu">
                    ...
                    @if (\Auth::user()->type != 'super admin' &&
                        ...
                        <li class="dash-item dash-hasmenu">
                            <a href="#!"
                                class="dash-link {{ Request::segment(1) == 'users' || Request::segment(1) == 'roles' || Request::segment(1) == 'clients' ? ' active dash-trigger' : '' }}"><span
