...
@section('action-btn')
    <div class="float-end">
        ...
        @can('edit customer')
            <a href="#" data-size="xl" data-url="{{ route('customer.edit',$customer['id']) }}" data-ajax-popup="true" title="{{__('Edit Customer')}}" data-bs-toggle="tooltip" data-original-title="{{__('Edit')}}" class="btn btn-sm btn-primary">
        ...
        <div class="col-md-4 col-lg-4 col-xl-4">
            <div class="card customer-detail-box customer_card">
                <div class="card-body">
                    ...
                    <p class="card-text mb-0">{{$customer['billing_city'].', '. $customer['billing_state'] .', '.$customer['billing_country']}}</p>
                </div>
            </div>
        ...
        <div class="col-md-4 col-lg-4 col-xl-4">
            <div class="card customer-detail-box customer_card">
                <div class="card-body">
                    ...
                    <p class="card-text mb-0">{{$customer['shipping_city'].', '. $customer['billing_state'] .', '.$customer['billing_country']}}</p>
                </div>
            </div>
