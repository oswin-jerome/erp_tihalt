                            ...
                            <div data-v-f2a183a6="" class="d-header" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        <div data-v-f2a183a6="" class="d-title "><?php echo e(__('Bill')); ?></div>
                                        <table data-v-f2a183a6="" class="summary-table">
                                            <tbody data-v-f2a183a6="">
                                            <tr>
                                                <td><?php echo e(__('Number')); ?>:</td>
                                                <td><?php echo e(Utility::billNumberFormat($settings,$bill->bill_id)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Issue Date')); ?>:</td>
                                                <td><?php echo e(Utility::dateFormat($settings,$bill->bill_date)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Due Date')); ?>:</td>
                                                <td><?php echo e(Utility::dateFormat($settings,$bill->due_date)); ?></td>
                                            </tr>
...
<?php /**PATH /Users/oswinjerome/Projects/erp/resources/views/bill/templates/template1.blade.php ENDPATH**/ ?>