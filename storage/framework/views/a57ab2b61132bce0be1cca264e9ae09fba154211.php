                            ...
                            <div data-v-f2a183a6="" class="d-header" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        <div data-v-f2a183a6="" class="d-title"><?php echo e(__('PROPOSAL')); ?></div>
                                        <table data-v-f2a183a6="" class="summary-table">
                                            <tbody data-v-f2a183a6="">
                                            <tr>
                                                <td><?php echo e(__('Number')); ?>:</td>
                                                <td><?php echo e(Utility::proposalNumberFormat($settings,$proposal->proposal_id)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Issue Date')); ?>:</td>
                                                <td><?php echo e(Utility::dateFormat($settings,$proposal->issue_date)); ?></td>
                                            </tr>
                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                            ...
                                            <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($color); ?>;">
                                                ...
                                                <div class="d-table-td w-2">
                                                    <pre data-v-f2a183a6=""><?php echo e($proposal->totalQuantity); ?></pre>
                                                </div>
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6=""><?php echo e(Utility::priceFormat($settings,$proposal->totalRate)); ?></pre>
                                                </div>
                                                <div class="d-table-td w-5">
                                                    <pre data-v-f2a183a6=""><?php echo e(Utility::priceFormat($settings,$proposal->totalTaxPrice)); ?></pre>
                                                </div>
                                                <?php if($proposal->discount_apply==1): ?>
                                                    <div class="d-table-td w-2">
                                                        <pre data-v-f2a183a6=""><?php echo e(Utility::priceFormat($settings,$proposal->totalDiscount)); ?></pre>
                                                    </div>
                                                <?php else: ?>
                                                    <div class="d-table-td w-2">
                                                        <pre data-v-f2a183a6="">-</pre>
                                                ...
                                                <div class="d-table-td w-4 text-right">
                                                    <span><?php echo e(Utility::priceFormat($settings,$proposal->getSubTotal())); ?>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    ...
                                                    <?php if($proposal->discount_apply==1): ?>
                                                        <?php if($proposal->getTotalDiscount()): ?>
                                                            <div data-v-f2a183a6="" class="d-table-summary-item">
                                                                ...
                                                                <div data-v-f2a183a6="" class="d-table-value"><?php echo e(Utility::priceFormat($settings,$proposal->getTotalDiscount())); ?></div>
                                                            </div>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid <?php echo e($color); ?>; border-bottom: 1px solid <?php echo e($color); ?>;">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(Utility::priceFormat($settings,$proposal->getSubTotal()-$proposal->getTotalDiscount()+$proposal->getTotalTax())); ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<?php /**PATH /Users/oswinjerome/Projects/erp/resources/views/proposal/templates/template1.blade.php ENDPATH**/ ?>