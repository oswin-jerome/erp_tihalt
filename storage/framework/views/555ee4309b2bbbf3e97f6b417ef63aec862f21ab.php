                ...
                <?php if( \Auth::user()->type !='client' && \Auth::user()->type !='super admin' ): ?>
                        <li class="dropdown dash-h-item drp-notification">
                            <a class="dash-head-link arrow-none me-0" href="<?php echo e(url('chats')); ?>" aria-haspopup="false" aria-expanded="false">
                                ...
                                <span class="bg-danger dash-h-badge dots"><span class="sr-only"><?php echo e($unseenCounter); ?></span></span>
                            </a>
...
<?php /**PATH /Users/oswinjerome/Projects/erp/resources/views/partials/admin/header.blade.php ENDPATH**/ ?>