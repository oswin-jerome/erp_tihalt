                        ...
                        <li class="dash-item dash-hasmenu
                            ...
                            <ul class="dash-submenu">
                                <?php if(\Auth::user()->show_account() == 1 && Gate::check('show account dashboard')): ?>
                                    <li class="dash-item dash-hasmenu <?php echo e(( Request::segment(1) == null   || Request::segment(1) == 'report') ? ' active dash-trigger' : ''); ?>">
                        ...
                        <?php if( Gate::check('manage employee') || Gate::check('manage setsalary')): ?>
                            <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'holiday-calender' || Request::segment(1) == 'reports-monthly-attendance' ||
                                ...
                                <ul class="dash-submenu">
                                    ...
                                    <?php if( Gate::check('manage training') || Gate::check('manage trainer')): ?>
                ...
                <ul class="dash-navbar">
                    ...
                    <?php endif; ?>
                        <?php if(Gate::check('manage contract')): ?>
                            <li class="dash-item dash-hasmenu<?php echo e((Request::segment(1) == 'contract')?'active':''); ?>">
...
<?php /**PATH /Users/oswinjerome/Projects/erp/resources/views/partials/admin/menu.blade.php ENDPATH**/ ?>