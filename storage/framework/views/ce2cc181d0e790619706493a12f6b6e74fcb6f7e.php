            ...
            <div class=" mt-2 " id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php endif; ?>                        <div class="row align-items-center justify-content-end">
                            <div class="col-xl-10">
                                <div class="row">
                            ...
                            <div class="col-auto mt-4">
                                <div class="row">
                                    <div class="col-auto">
                                        ...
                                        <?php else: ?>
                                            <a href="<?php echo e(route('vender.bill')); ?>" class="btn btn-sm btn-danger " data-bs-toggle="tooltip"  title="<?php echo e(__('Reset')); ?>" data-original-title="<?php echo e(__('Reset')); ?>">
                                                <span class="btn-inner--icon"><i class="ti ti-trash-off text-white-off "></i></span>
                                            </a>
                                        <?php endif; ?>
                        ...
                        <table class="table datatable">
                            ...
                            <?php $__currentLoopData = $bills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="Id">
                                        <?php if(\Auth::guard('vender')->check()): ?>
                                            <a href="<?php echo e(route('vender.bill.show',\Crypt::encrypt($bill->id))); ?>" class="btn btn-outline-primary"><?php echo e(AUth::user()->billNumberFormat($bill->bill_id)); ?></a>
                                        <?php else: ?>
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show bill')): ?>
                                                    <?php if(\Auth::guard('vender')->check()): ?>
                                                        <div class="action-btn bg-info ms-2">
                                                            <a href="<?php echo e(route('vender.bill.show',\Crypt::encrypt($bill->id))); ?>" class="mx-3 btn btn-sm align-items-center" data-bs-toggle="tooltip" title="<?php echo e(__('Show')); ?>" data-original-title="<?php echo e(__('Detail')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/oswinjerome/Projects/erp/resources/views/bill/index.blade.php ENDPATH**/ ?>