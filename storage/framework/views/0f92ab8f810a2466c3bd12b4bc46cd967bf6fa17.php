                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        ...
                                        <table data-v-f2a183a6="" class="summary-table">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e(Utility::invoiceNumberFormat($settings,$invoice->invoice_id)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Issue Date')); ?>:</td>
                                                <td><?php echo e(Utility::dateFormat($settings,$invoice->issue_date)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Due Date')); ?>:</td>
                                                <td><?php echo e(Utility::dateFormat($settings,$invoice->due_date)); ?></td>
                                            </tr>
                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                                ...
                                                <?php if(isset($invoice->itemData) && count($invoice->itemData) > 0): ?>
                                                    <?php $__currentLoopData = $invoice->itemData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($color); ?>;">
                                                            ...
                                                            <div class="d-table-td w-4 text-right"><span><?php echo e(Utility::priceFormat($settings,$item->price * $item->quantity)); ?></span></div>
                                                        </div>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php else: ?>
                                                    <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($color); ?>;">
                                            ...
                                            <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($color); ?>;">
                                                ...
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6=""><?php echo e(Utility::priceFormat($settings,$invoice->totalRate)); ?></pre>
                                                </div>
                                                <div class="d-table-td w-5">
                                                    <pre data-v-f2a183a6=""><?php echo e(Utility::priceFormat($settings,$invoice->totalTaxPrice)); ?></pre>
                                                </div>
                                                <?php if($invoice->discount_apply==1): ?>
                                                    <div class="d-table-td w-2">
                                                        <pre data-v-f2a183a6=""><?php echo e(Utility::priceFormat($settings,$invoice->totalDiscount)); ?></pre>
                                                    </div>
                                                <?php else: ?>
                                                    <div class="d-table-td w-2">
                                                        <pre data-v-f2a183a6="">-</pre>
                                                ...
                                                <div class="d-table-td w-4 text-right">
                                                    <span><?php echo e(Utility::priceFormat($settings,$invoice->getSubTotal())); ?>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(Utility::priceFormat($settings,$invoice->getSubTotal())); ?></div>
                                                    </div>
                                                    <?php if($invoice->getTotalDiscount()): ?>
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Discount')); ?>:</div>
                                                            <div data-v-f2a183a6="" class="d-table-value"><?php echo e(Utility::priceFormat($settings,$invoice->getTotalDiscount())); ?></div>
                                                        </div>
                                                    <?php endif; ?>
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(Utility::priceFormat($settings,$invoice->getSubTotal()-$invoice->getTotalDiscount()+$invoice->getTotalTax())); ?></div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Paid')); ?>:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(Utility::priceFormat($settings,($invoice->getTotal()-$invoice->getDue())-($invoice->invoiceTotalCreditNote()))); ?></div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Credit Note')); ?>:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(Utility::priceFormat($settings,($invoice->invoiceTotalCreditNote()))); ?></div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Due Amount')); ?>:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(Utility::priceFormat($settings,$invoice->getDue())); ?></div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php /**PATH /Users/oswinjerome/Projects/erp/resources/views/invoice/templates/template1.blade.php ENDPATH**/ ?>